...
export default function DRVanityGenerator() {
  ...
  return (
    <div className="min-h-screen bg-[url('/grainy-metal-texture.png')] bg-dark-gray text-white flex flex-col items-center p-2 md:p-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4 w-full max-w-sm justify-center">
        <button className="w-full sm:w-auto rounded-lg px-6 py-2 border-2 border-cyan-400 bg-gray-900 hover:bg-cyan-950 transition font-bold shadow-md" aria-label="Connect Wallet">Connect Wallet</button>
        <button className="w-full sm:w-auto rounded-lg px-6 py-2 border-2 border-cyan-400 bg-gray-900 hover:bg-cyan-950 transition font-bold shadow-md" aria-label="Connect Telegram">Connect Telegram</button>
      </div>
